...
The project is about improving my programming skills using python.

Image Classification for a City Dog Show

Project Goal
Improving my programming skills using Python.
In this project, i used an image classifier to identify dog breeds. i was asked to focus on Python and not on the actual classifier.
